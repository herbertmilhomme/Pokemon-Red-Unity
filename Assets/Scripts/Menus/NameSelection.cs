...
public class NameSelection : MonoBehaviour 
{
	...
	void Update () 
	{
		nameselectscreen.sprite = isLowerCase ? lowercase : uppercase;
		displaytext.text = futureName;
		maxNameSize = (OakIntroCutsceneHandler.instance.givingRedAName || OakIntroCutsceneHandler.instance.givingGaryAName) ? 7 : 10;
